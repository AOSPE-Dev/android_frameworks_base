...
public class PELogo extends Activity {
    ...
    final static int TEXT_BACK = 0xCCCCCCCC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.aospe_logo);
        ...
        String peVersion = SystemProperties.get("ro.aospe.version");
        peVersion = peVersion.replaceAll("([0-9\\.]+?)-.*", "$1");
        tv.setText("AOSP Edition " + peVersion);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    android.util.Log.e("PELogo", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
